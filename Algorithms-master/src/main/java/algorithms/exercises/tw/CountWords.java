...
public class CountWords {
    public static void main(String[] args) {
        ...
        int res1 = countWords("table chair pen  food  bird    chicken");
        int res2 = countWords("table chair pen    bird    chicken ");
        int res3 = countWords(" table chair     bird    chicken");
        int res4 = countWords(" table chair pen    bird    chicken ");
        int res5 = countWords("table chair pen       chicken ");
        int res6 = countWords("     table chair pen    bird    chicken     ");
        int res7 = countWords("      chair pen    bird    chicken");
